...
<alpino_ds version="1.6">
    ...
    <metadata>
        ...
        <meta type="text" name="language" value="nld" /><meta type="int" name="months" value="57" /><meta type="text" name="role" value="Target_Child" /><meta type="text" name="sex" value="female" />
        <meta type="text" name="xsid" value="24" /><meta type="int" name="uttno" value="24" />
    </metadata>
</alpino_ds>'''
