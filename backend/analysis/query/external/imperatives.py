...
noimplemmas = {'hoeven', 'moeten', 'mogen',
               'kunnen', 'hebben', 'willen', 'hebben', 'zitten'}
noimpwords = {'ben', 'bent'}
    ...
    for cand in cands:
        ...
        for hd in hds:
            for su in sus:
                ...
                hdpotimp = (hdpvtijd == 'tgw' and hdpvagr == 'ev' and (
                    hdlemma != 'zijn' or hdword == 'wees'))
...
def impwi(syntree, nodecounts):
    ...
    for cand in cands:
        ...
        for hd in hds:
            ...
            ok = ok and (stype == 'imparative' or (
                modlemmas.intersection(impmodlemmas) != {}))
            #print('ok=', ok)
